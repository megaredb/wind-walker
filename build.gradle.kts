...
dependencies {
	...
	*/
	...
	modImplementation("dev.kosmx.player-anim:player-animation-lib-fabric:${properties["player_anim"]}")
	include("dev.kosmx.player-anim:player-animation-lib-fabric:${properties["player_anim"]}")
}
